...
const dataPath = "C:/Bisnis/finesheet-omnichannel/outputs/tiktok-to-tiktok/inspection/final_preview_rows.json";
const outputDir = "C:/Bisnis/finesheet-omnichannel/outputs/tiktok-to-tiktok/inspection/final-previews";
...
for (const item of data) {
  ...
  await fs.writeFile(path.join(outputDir, `seosm-${item.index}-final.png`), new Uint8Array(await preview.arrayBuffer()));
}
