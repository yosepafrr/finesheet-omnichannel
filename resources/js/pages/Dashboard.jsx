        ...
        <AppLayout>
            <div className="min-h-[calc(80vh-64px)] w-full bg-slate-50 dark:bg-slate-900 transition-colors duration-300 flex items-center justify-center p-4">
                <div className="text-center animate-fade-in-up bg-white dark:bg-slate-800 p-12 rounded-3xl shadow-sm border border-gray-100 dark:border-slate-700 max-w-lg w-full">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-50 dark:bg-blue-500/10 mb-6">
                        <span className="material-symbols-rounded text-4xl text-blue-500 dark:text-blue-400">dashboard_customize</span>
                    </div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-3">Dashboard Segera Hadir</h1>
                    <p className="text-gray-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed">
                        Kami sedang mengembangkan modul dashboard dengan fitur analitik yang lebih komprehensif dan terintegrasi dengan berbagai marketplace.
                    </p>
